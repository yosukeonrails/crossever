     ...
     return(
        <div>
            ...
            <div className="sign-up-box">
                ...
                <h1>Sign Up</h1>
                <button id="facebook-signup-button" onClick={this.facebooklogin}> Facebook Sign Up </button>
                </div>
            ...
            <button style={{ top:'75%'}} onClick={this.submitSignUp} id="done-login-button"> Done </button>
