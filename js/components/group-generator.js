...
export class GroupGenerator extends React.Component{
...
var GroupGeneratorContainer = connect(mapStateToProps)(GroupGenerator);

export default GroupGeneratorContainer;
